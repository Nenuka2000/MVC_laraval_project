      ...
      <table class="min-w-full">
        <thead>
          <tr>
            ...
            <th class="px-6 py-3 bg-gray-200 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Customer</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="border border-gray-400 px-4 py-2">{{$order->user->first_name}} {{$order->user->last_name}}</td>
            ...
            <td class="border border-gray-400 px-4 py-2">
              <a href="/admin/orders/{{$order->id}}/edit" class="text-blue-500 hover:underline">Edit</a>
            </td>
          </tr>
          @endforeach
        </tbody>
